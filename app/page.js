...
const T = {
  ru: {
    ...
    heroTitle: "Химчистка в\u00A0Астане — бережный уход за\u00A0вашими вещами",
    heroSub: "Профессиональная химчистка одежды, обуви, штор и домашнего текстиля. Аккуратный сервис, понятная консультация, 3 пункта приёма.",
